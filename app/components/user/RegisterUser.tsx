				...
				<div className="flex flex-col max-w-[300px] mb-6 max-md:mb-4">
					<div className="mb-2">
						...
						<input 
							...
							name="email"
							type="email"
							className={`w-full border rounded-sm shadow-md block px-2 h-12 ${emailErrorMessage ? ("border-red-400") : ("border-gray-200")} max-md:h-10 max-md:shadow-sm`}
							value={email}
					...
					<div className="mb-2">
						...
						<input
							...
							name="password"
							type="password"
							className={`w-full border rounded-sm shadow-md block px-2 h-12 ${passwordErrorMessage ? ("border-red-400") : ("border-gray-200")} max-md:h-10 max-md:shadow-sm`}
							value={password}
					...
					<div className="mb-2">
						...
						<input
							...
							name="displayName"
							type="text"
							className={`w-full border rounded-sm shadow-md block px-2 h-12 ${displayNameErrorMessage ? ("border-red-400") : ("border-gray-200")} max-md:h-10 max-md:shadow-sm`}
							value={displayName}
